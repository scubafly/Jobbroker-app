...
// in simulator we redefine to format for Jobbroker Developer console
...
{\
	NSString * exceptionName = [@"org.jobbroker." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.jobbroker";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIJobbrokerNativeItemNone = -1, 
	UIJobbrokerNativeItemSpinner = -2,
	UIJobbrokerNativeItemProgressBar = -3,
	
	UIJobbrokerNativeItemSlider = -4,
	UIJobbrokerNativeItemSwitch = -5,
	UIJobbrokerNativeItemMultiButton = -6,
	UIJobbrokerNativeItemSegmented = -7,
	
	UIJobbrokerNativeItemTextView = -8,
	UIJobbrokerNativeItemTextField = -9,
	UIJobbrokerNativeItemSearchBar = -10,
	
	UIJobbrokerNativeItemPicker = -11,
	UIJobbrokerNativeItemDatePicker = -12,
	
	UIJobbrokerNativeItemInfoLight = -13,
	UIJobbrokerNativeItemInfoDark = -14,
	
	UIJobbrokerNativeItemDisclosure = -15,
	
	UIJobbrokerNativeItemContactAdd = -16
};
